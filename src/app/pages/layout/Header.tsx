        ...
        <MenuListWrapper>
          <MenuList>
            <Menu>
              <Link href="/">
                <TextLogo>
                  <span className="primary">배달의</span>
                  <span>돼지</span>
                </TextLogo>
              </Link>
            </Menu>
            <Menu>
              <Link href="/">
                <MenuButton>주문</MenuButton>
              </Link>
              <Link href="/">
                <MenuButton>가맹점</MenuButton>
              </Link>
            </Menu>
            <SearchMenu>
              <SearchContainer>
              ...
              <SearchResultWrapper>
                <SearchResultList>
                  {/*
                  searchResult?.data.results.map((searched) => (
                    <Link key={searched.id} href={`/movie/${searched.id}`}>
            ...
            <Menu>
              <Link href="/signIn">
                <AntButton>로그인</AntButton>
              </Link>
            </Menu>
            <Menu>
              <Link href="/signUp">
                <AntButton>회원가입</AntButton>
              </Link>
            </Menu>
          </MenuList>
        </MenuListWrapper>
